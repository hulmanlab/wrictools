...
```{r}
visualize_with_protocol("./example_data/my_project/AB56_Visit 1_WRIC_data.csv") # default is RER
# visualize_with_protocol("./example_data/my_project/AB56_Visit 1_WRIC_data.csv", 
#                         plot="Energy Expenditure (kcal/min)", 
