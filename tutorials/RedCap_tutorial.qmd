...
```{r, eval=FALSE}
result <- preprocess_WRIC_files("./example_data/record_ids.csv", "WRIC_raw", code = "id", save_csv = TRUE)
...
```{r, eval=FALSE}
upload_file_to_redcap(filepath = "./example_data/XXXX_WRIC_data.csv", record_id = "12345", fieldname = "WRIC_processed")
```
